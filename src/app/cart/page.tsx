    ...
    <div className="h-[calc(100vh-6rem)] md:h-[calc(100vh-9rem)] flex flex-col text-orange-500 lg:flex-row">
      ...
      <div className="h-1/2 p-4 flex flex-col justify-center overflow-scroll lg:h-full lg:w-2/3 2xl:w-1/2 lg:px-20 xl:px-40">
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <h2 className="font-bold">Rs 120.0</h2>
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <h2 className="font-bold">Rs 80.0</h2>
          <span className="cursor-pointer">X</span>
        </div>
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <h2 className="font-bold">Rs 180.0 </h2>
          <span className="cursor-pointer">X</span>
        </div>
      </div>
      ...
      <div className="h-1/2 p-4 bg-fuchsia-50 flex flex-col gap-4 justify-center lg:h-full lg:w-1/3 2xl:w-1/2 lg:px-20 xl:px-40 2xl:text-xl 2xl:gap-6">
        ...
        <div className="flex justify-between">
          ...
          <span className="font-bold">Rs 380.0</span>
        </div>
